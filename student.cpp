...
student::student(string _fname, string _lname, string _ssn, double _examScores) {
    fname = _fname;
    lname = _lname;
    ssn = _ssn;
...
void student::setexamScores(double _examScores) {
    examScores=_examScores;
    //for (int i = 0; i < 4 ; i++)
	//{
    //    examScores[i] = _examScores[i];
...
//    cout << left << setw(15) << fname << setw(15) << lname << setw(15) << ssn << endl;
//}
//  << setw(15) << examScores << setw(15) << studentNumber